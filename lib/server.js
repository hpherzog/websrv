...
Server.prototype.createExpressApp = function() {
    ...
    self.expressApp.set('views', self.basePath + '/views');
    ...
    for(var i in self.appDefinitions) {
        self.appDefinitions[i](self.expressApp);
    };
...
Server.prototype.start = function start() {
    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            self.wss = new wss.WebSocketServer({
...
Server.prototype.control = function control(definition) {
    this.appDefinitions.push(definition);
};
