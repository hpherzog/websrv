...
var ws = require(__dirname + "/wss.js");
...
function VirtualHost (options) {
    ...
    this.config = _.isFunction(options.config)?
        options.config : function(){
        self.server.logger.info('Empty configuration for ' + self.host);
    };
...
Server.prototype.start = function start() {
    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            self.wssServer = new ws.WebSocketServer({
...
Server.prototype.vhost = function vhost(host, config, define) {
